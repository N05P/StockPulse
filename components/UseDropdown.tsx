...
const UseDropdown = () => {
    ...
    const user = {name:"Priyanshu Negi",email:"pn545@gmail.com"}

    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className='flex itmes-center gap-2 hover:text-yellow-500'>
            ...
            <DropdownMenuContent className='text-gray-400'>
                ...
                <DropdownMenuSeparator className='text-gray-500 hidden sm:block'/>
